	  ...
	  collapsed:: true
		- sku_category transaction_count distribution
		  collapsed:: true
			...
			- Data
				- ![image.png](../assets/scanner_retail_data/image_1766119032164_0.png)
				- ![image.png](../assets/scanner_retail_data/image_1766492846262_0.png)
		  ...
		  collapsed:: true
			...
			- Data
				...
				- Top 5 sku_categories with most transactions
					- ![image.png](../assets/scanner_retail_data/image_1766492807569_0.png)
				...
				- 5 sku_categories with half the amount of transactions of the top 5
					- ![image.png](../assets/scanner_retail_data/image_1766493532454_0.png)
				...
				- 5 sku_categories with quarter the amount of transactions of the top 5
					- ![image.png](../assets/scanner_retail_data/image_1766493647271_0.png){:height 367, :width 659}
				...
				- Bottom 5 sku_categories with transactions equal to or greater than 10
					- ![image.png](../assets/scanner_retail_data/image_1766507003038_0.png){:height 382, :width 659}
	...
	- Graphs
		...
		- Data
			- Top 5 customers and their transactions
				- ![image.png](../assets/scanner_retail_data/image_1766505011625_0.png)
			- 5 customers with half the amount of transactions
				- ![image.png](../assets/scanner_retail_data/image_1766505173198_0.png)
			- 5 customers quarter the amount of transactions
				- ![image.png](../assets/scanner_retail_data/image_1766505243957_0.png)
